...
public class ConvertColor
{
  ...
  // defines color spaces 
	...
	void Patching_get_gray_row(CompressInfo cinfo, short[] pixel_row) throws Exception
	{
/*
		int col;
		...
		getChannel(cinfo.ji, row_idx_, jiBufByt, 0);
        ++row_idx_;
...
*/
	...
	public void get_rgb_ycc_rows (CompressInfo cinfo, int rows_to_read, short[][][] image_data) throws Exception
	{
		int r, g, b;
		int col;
		int row;
	 ...
	 */
	public void get_grayscale_rows (CompressInfo cinfo, int rows_to_read, short[][][] image_data) throws Exception
	{
	  int row,col;
